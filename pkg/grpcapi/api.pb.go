...
func (x *ClientTaskResponse) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
const file_api_proto_rawDesc = "" +
	...
	"\x12ClientTaskResponse\x12\x16\n" +
	"\x06taskID\x18\x01 \x01(\tR\x06taskID\x12\x10\n" +
	"\x03msg\x18\x02 \x01(\tR\x03msg\"L\n" +
	"\x14SendHeartbeatRequest\x12\x1a\n" +
	...
	"\rWorkerService\x12;\n" +
	"\n" +
	"SubmitTask\x12\x14.grpcapi.TaskRequest\x1a\x15.grpcapi.TaskResponse\"\x002\x8a\x02\n" +
	"\x12CoordinatorService\x12G\n" +
	"\n" +
	"SubmitTask\x12\x1a.grpcapi.ClientTaskRequest\x1a\x1b.grpcapi.ClientTaskResponse\"\x00\x12P\n" +
	"\rSendHeartbeat\x12\x1d.grpcapi.SendHeartbeatRequest\x1a\x1e.grpcapi.SendHeartbeatResponse\"\x00\x12Y\n" +
	"\x10UpdateTaskStatus\x12 .grpcapi.UpdateTaskStatusRequest\x1a!.grpcapi.UpdateTaskStatusResponse\"\x00B=Z;github.com/ben-khong/Distributed-Task-Scheduler/pkg/grpcapib\x06proto3"
...
var file_api_proto_goTypes = []any{
	...
	(*SendHeartbeatRequest)(nil),     // 5: grpcapi.SendHeartbeatRequest
	(*SendHeartbeatResponse)(nil),    // 6: grpcapi.SendHeartbeatResponse
...
var file_api_proto_depIdxs = []int32{
	...
	5, // 3: grpcapi.CoordinatorService.SendHeartbeat:input_type -> grpcapi.SendHeartbeatRequest
	...
	6, // 7: grpcapi.CoordinatorService.SendHeartbeat:output_type -> grpcapi.SendHeartbeatResponse
